module "ecs" {
  ...
  task_environment_variables = [
    ...
    {
      name : "JAVA_OPTS"
      value : "-Dquarkus.http.host=0.0.0.0 -Djava.util.logging.manager=org.jboss.logmanager.LogManager -Dquarkus.http.cors=true -Dquarkus.http.cors.headers=origin,accept,authorization,content-type,x-requested-with -Dquarkus.http.cors.origins=https://registry.infrahouse.com"
    }
  ]
